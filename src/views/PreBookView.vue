    ...
    export default {
        data() {
            return {
                ...
                bookFee: {
                    title: '收費方式',
                    content: ['預約時段分為上午、下午、傍晚及晚上，以人數計費，費用有平假日之分，請參下表。', '時段說明：上午(09:00-12:00)、下午(12:00-15:00)、傍晚(15:00-18:00)、晚上(18:00-21:00)。', '本店提供餐點及飲料，全面禁止攜帶外食。', '3歲以下不另行收費，請勿使用桌遊；12歲以下，須由大人陪同入場。', '提供包場服務，請直接洽詢客服人員。', '若需取消預約，請於預約開始12小時前取消，預約兩次未到將停權六個月。']
                },
                bookDirection: {
                    title: '預約方式',
