<template>
  <main>
    ...
    <div class="header_banner">
      ...
      <img :src="games" alt="Banner games" id="games" @mouseenter="showGamesCard = true" @mouseleave="showGamesCard = false"/>
      ...
      <img :src="comment" alt="Banner comments" id="comment" @mouseenter="showCommentCard = true" @mouseleave="showCommentCard = false"/>
      <div v-if="showCommentCard" id="commentCard" class="showCard">
        <p class="card-title">留言板</p>
        <div class="card-line"></div>
        <p class="card-text">玩家交流之地，分享桌遊經驗，結織世界友誼。</p>
      </div>
      <img :src="news" alt="Banner News" id="news"  @mouseenter="showNewsCard = true" @mouseleave="showNewsCard = false"/>
      <div v-if="showNewsCard" id="newsCard" class="showCard">
        <p class="card-title">最新消息</p>
        <div class="card-line"></div>
        <p class="card-text">板上新蹤，於此發掘格線島之近況與盛事。</p>
      </div>
      <img :src="sign" alt="Banner Sign" id="sign" @mouseenter="showSignCard = true" @mouseleave="showSignCard = false"/>
      <div v-if="showSignCard" id="signCard" class="showCard">
        <p class="card-title">關於我們</p>
        <div class="card-line"></div>
        <p class="card-text">格間交織於此，智者競技，譜寫桌遊新篇章。</p>
      </div>
      <img :src="reserve" alt="Banner Reserve" id="reserve" @mouseenter="showReserveCard = true" @mouseleave="showReserveCard = false"/>
      ...
      <img :src="cart" alt="Banner Cart" id="cart" @mouseenter="showCartCard = true" @mouseleave="showCartCard = false" />
